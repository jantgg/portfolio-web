...
const CirculoS4 = ({ children, ruta, hacerScroll, onCustomClick, fontSize= '3vw' }) => {
  ...
  const handleClickEmail = () => {
    // Abre un email al hacer clic, en lugar de navegar o hacer scroll
    window.location.href = "mailto:jantgomezgil@hotmail.com";
  };
